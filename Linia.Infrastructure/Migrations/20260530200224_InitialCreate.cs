        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerNickname = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Boards_OwnerNickname",
                table: "Boards",
                column: "OwnerNickname");

            migrationBuilder.CreateIndex(
                name: "IX_Elements_AuthorNickname",
                table: "Elements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Elements_PageId_ZIndex",
                table: "Elements",
                columns: new[] { "PageId", "ZIndex" });
